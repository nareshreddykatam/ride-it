...
const selectVariants = cva(
  "w-full appearance-none rounded-lg border bg-white pl-4 pr-9 text-sm text-ink outline-none transition-colors disabled:cursor-not-allowed disabled:opacity-50",
  {
    variants: {
      size: {
        sm: "h-9 text-sm",
