  ...
  return (
    <main className="flex-1 px-6 py-8">
      ...
      <p className="mt-1 pl-11 text-sm text-ink-soft">
        Manage emergency contacts, review past reports, and reach us if something felt wrong on a trip.
      </p>
          ...
          <Card interactive className="flex items-center justify-between gap-3">
            <span className="flex items-center gap-3">
              ...
              <span>
                ...
                <span className="block text-xs text-ink-soft">An unsafe passenger, harassment, or anything else from a past trip</span>
              </span>
            </span>
            <ChevronRight size={16} className="shrink-0 text-ink-soft" aria-hidden="true" />
          </Card>
