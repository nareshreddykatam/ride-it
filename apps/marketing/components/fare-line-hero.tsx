 ...
 * - "Ridora": a flat, calm line — one fixed subscription fee, drivers keep the rest
...
export function FareLineHero() {
  return (
    <div className="w-full rounded-2xl border border-border bg-surface p-6 shadow-lg">
      <svg viewBox="0 0 480 160" className="w-full" role="img" aria-label="Ridora flat subscription fee compared to competitors' variable per-ride commission">
